...
export default function Profile() {
    ...
    const handlePasswordEditing = (e) => {
        ...
        if (passwordForm.isEditing) {
            if (passwordForm.new_pwd.value !== passwordForm.confirm_pwd.value)
                return;
            authQuery(
                editPassword({
                    ...
                    if (data.error.name === 'InvalidIdentifiersError') {
                        ...
                        setPasswordForm((prevValue) => {
                            ...
                            return {
                                ...
                                old_pwd: {
                                    ...old_pwd,
                                    error: errors.old_pwd,
                                    errorMessage: errors.old_pwd
                                ...
                                new_pwd: {
                                    ...
                                    errorMessage: errors.new_pwd
                                        ? 'Veuillez renseigner votre nouveau mot de passe'
                                        : '',
                                },
                                confirm_pwd: {
                                    ...confirm_pwd,
                                    error: errors.confirm_pwd,
                                    errorMessage: errors.confirm_pwd
    ...
    const confirmPasswordError = useCallback((prevValue, inputValue) => {
        return prevValue.length !== 0 ? prevValue !== inputValue : false;
    }, []);
                ...
                setPasswordForm((prevValue) => {
                    return {
                        ...
                        confirm_pwd: {
                            ...
                            errorMessage:
                                prevValue.new_pwd.value !== inputValue
                            ...
                            <div className="input-wrapper">
                                ...
                                <div className="inputfield-wrapper">
                                    <input
                                        ...
                                        disabled={!form.mail.inEdit}
                                        onChange={handleChange}
                                        className={
                                            form.mail.error ? 'input-error' : ''
                                        }
                                    />
                                    <button
                                        title="Modifier le mail"
                                        onClick={(e) =>
                                            handleEditing(e, 'mail')
                                        }
                                    >
                                        <img
                                            src={
                            ...
                            {!passwordForm.isEditing ? (
                                <div className="input-wrapper">
                                    ...
                                    <div className="inputfield-wrapper">
                                        <input
                                            ...
                                            className="flouter"
                                        />
                                        <button onClick={handlePasswordEditing}>
                                            <img
                                                src={boutonModifier}
                                                width="15px"
                                            />
                                ...
                                <div className="wrapper-boutons-passwords">
                                    <div className="input-wrapper">
                                        ...
                                        <div className="inputfield-wrapper">
                                            <input
                                                ...
                                                type="password"
                                                value={
                                                    passwordForm.old_pwd.value
                                                }
                                                onChange={(e) =>
                                                    handlePasswordChange(e)
                                                }
                                                className={
                                                    passwordForm.old_pwd.error
                                                        ? 'input-error'
                                                        : ''
                                                }
                                            />
                                        ...
                                        <div className="error">
                                            {passwordForm.old_pwd.errorMessage}
                                        </div>
                                    </div>
                                    <div className="input-wrapper">
                                        <label htmlFor="pwd">
                                        ...
                                        <div className="inputfield-wrapper">
                                            <input
                                                ...
                                                type="password"
                                                value={
                                                    passwordForm.new_pwd.value
                                                }
                                                onChange={handlePasswordChange}
                                                className={
                                                    passwordForm.new_pwd.error
                                                        ? 'input-error'
                                                        : ''
                                                }
                                            />
                                        ...
                                        <div className="error">
                                            {passwordForm.new_pwd.errorMessage}
                                        </div>
                                    </div>
                                    <div className="input-wrapper">
                                        <label htmlFor="pwd">
                                    ...
                                    <div className="password-buttons">
                                        <button
                                            className="bouton-password-edit bouton-password-edit-annuler"
                                            onClick={quitPasswordEditing}
                                        >
                                            <img
                                                src={boutonAnnuler}
                                                width="25px"
                                        ...
                                        <button
                                            className="bouton-password-edit bouton-password-edit-valider"
